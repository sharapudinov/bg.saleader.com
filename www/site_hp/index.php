...
$APPLICATION->SetPageProperty("keywords", "Готовый интернет-магазин DELUXE");
$APPLICATION->SetPageProperty("description", "Готовый интернет-магазин DELUXE");
$APPLICATION->SetTitle("Готовый интернет-магазин DELUXE");?>					
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PICTURE_WIDTH" => "220",
		"PICTURE_HEIGHT" => "200",
		"PROP_VALUE" => array(0 => "47",1 => "51",2 => "48",3 => "50",4 => "49",),
		"ELEMENTS_COUNT" => "10",
